...
public class LottoApp {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:\\Users\\stavp\\Desktop\\text.txt"));
             PrintStream ps = new PrintStream("C:\\Users\\stavp\\Desktop\\text-out.txt", StandardCharsets.UTF_8)) {
